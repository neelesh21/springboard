...
sat.income.mod <-  lm(energy ~ metro + income + house,
                      data = na.omit(states.data))
sat.mod <- update(sat.mod, data=na.omit(states.data))
# compare using the anova() function
...
sat.mod2 <- lm(energy ~ metro*income, data=states.data) 
...
sat.mod3 <- lm(energy ~ region, data=states.data) 
